...
export const faq = [
  {
    ...
    answer: "Зависит от формата, количества экранов и интеграций. Простые лендинги начинаются от 15 230 ₽."
  },
  {
    question: "Сколько времени занимает разработка?",
    answer: "Лендинг обычно 3–5 дней, сайт под ключ до 7 дней. Сервисы и боты оцениваются отдельно."
  },
  {
